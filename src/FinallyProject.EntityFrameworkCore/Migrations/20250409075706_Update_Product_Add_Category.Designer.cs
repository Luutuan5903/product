...
namespace FinallyProject.Migrations
{
    ...
    [Migration("20250409075706_Update_Product_Add_Category")]
    partial class Update_Product_Add_Category
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinallyProject.Products.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinallyProject.Products.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("FinallyProject.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("FinallyProject.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("FinallyProject.Products.Product", b =>
                {
                    b.HasOne("FinallyProject.Products.Category", "Category")
                        .WithMany("Products")
