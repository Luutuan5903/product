...
{
    public abstract class FinallyProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FinallyProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FinallyProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FinallyProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FinallyProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FinallyProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FinallyProjectDbContext, Task<T>> func)
        {
            T result;
